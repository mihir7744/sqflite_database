...
class _Page2State extends State<Page2> {
                ...
                setState(()async {
                  showDialog(context: context, builder: (context) {
                    return AlertDialog(
                      ...
                      content: Text('This contact will be removed from devices.'),
                      actions: [
  ...
  editcontect(){
    showModalBottomSheet(context: context, shape: RoundedRectangleBorder(borderRadius: BorderRadius.vertical(top: Radius.circular(20))),builder: (context) {
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Spacer(),
              Text("Edit contact",style: TextStyle(fontSize: 25.sm),),
              Spacer(),
              Expanded(
                flex: 3,
                child: Container(
                ...
                child: Container(
                  width: double.infinity,
                    ...
                    child: ElevatedButton(onPressed: ()async{
                        ...
                        final Datab model = Datab(name: name, contect: contect,id: widget.data?.id);
                    ...
                    }, child: Text("Edit",style: TextStyle(fontSize: 17.sm),))),
              ),
