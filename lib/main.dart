                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      onTap: () {
                        ...
                        setState(() {
                          print("image ====${snapshot.data![index].image}");
                        });
                      },
                      child: Card(
                        child: ListTile(
                          leading: CircleAvatar(
                            radius: 30,
                            backgroundImage: FileImage(new File(
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: CircleAvatar(
                  ...
                  backgroundImage: img.isEmpty ? null : FileImage(File(img)),
                ),
              ),
              // Spacer(),
              Container(
                ...
                children: [
                  ...
                  ElevatedButton(
                      onPressed: () async {
                        ...
                        print(
                            "Data length========= ${Databasehelper.getData.toString()}");
                        ...
                        print(
                            "data model ============${model.name}, ${model.contect},${model.image}");
                        await Databasehelper.addNote(model);

                        img = "";
                        textEditingController.text = "";
                        textEditingController_.text = "";
